    ...
    <div class="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 py-14 sm:py-18">
      <div class="grid gap-10 lg:grid-cols-12 lg:items-start">
        <div class="lg:col-span-7">
          ...
          >
            Увлекаюсь дронами, велосипедными прогулками и фотографией. Люблю
            минималистичный дизайн, музыку и путешествия.
          </p>
          ...
          <div class="mt-8">
            ...
            <ul class="mt-3 flex flex-wrap gap-2">
              <li
                ...
                :key="item"
                class="rounded-full border border-[color:var(--border)] bg-[color:var(--bg)] px-3 py-1 text-xs sm:text-sm text-[color:var(--muted)]"
              >
                {{ item }}
              </li>
            </ul>
          ...
          >
            ...
            <div class="relative">
              <div class="flex items-start justify-between gap-4">
                ...
                >
                  <p class="text-xs text-[color:var(--muted)]">Формат</p>
                  <p class="text-sm font-medium text-[color:var(--text)]">
                    удаленно
                  </p>
                </div>
              ...
              <div class="mt-6 grid gap-3">
                ...
                >
                  ...
                  <p class="mt-2 text-sm text-[color:var(--text)]">
                    Поддерживаю текущие проекты, собираю новые штуки и
                    постепенно довожу всё до состояния «удобно пользоваться и не
                    страшно менять».
                  </p>
                </div>
                ...
                >
                  ...
                  <p class="mt-2 text-sm text-[color:var(--text)]">
                    Предпочитаю спокойный темп, ясные договорённости и код,
                    который читается так же легко, как и работает.
                  </p>
                </div>
              </div>
